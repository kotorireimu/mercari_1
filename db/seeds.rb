...
Feeburden.create(name: '---')
Feeburden.create(name: '送料込み(出品者負担)')
Feeburden.create(name: '着払い(購入者負担)')

Handingtime.create(name: '---')
Handingtime.create(name: '1~2日で発送')
Handingtime.create(name: '2~3日で発送')
Handingtime.create(name: '4~7日で発送')
